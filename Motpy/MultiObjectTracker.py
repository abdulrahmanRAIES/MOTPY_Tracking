...
class Tracker:
    def __init__(
            ...
            max_staleness: float = 12.0,countrtid:float = 0.0):
        self.id = str(countrtid)
...
class MultiObjectTracker:
    ...
    def step(self, detections: Sequence[Detection],idcounter):
        ...
        for det_idx in set(range(len(detections))).difference(assigned_det_idxs):
            ...
            tracker = Tracker(box0=detections[det_idx].box,
                              ...
                              **self.tracker_kwargs,countrtid=idcounter)
            idcounter=idcounter+1
        ...
        return self.active_tracks(**self.active_tracks_kwargs),idcounter
